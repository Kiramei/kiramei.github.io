...
jQuery.event.add(window, "load", function () {
    ...
    $(".albumPanel").css("top", ((wid - 1920) / 8.0 + 220) + "px");
    $(".albumPanel_nav").css("top", ((wid - 1920) / 5 + 290) + "px");
    $(".ef").css("font-size",((wid-1920)/50+36)+"px");
    $(".ff").css("font-size",((wid-1920)/50+36)+"px");
    $(".event_psg").css("font-size",((wid-1920)/50+16)+"px");
    $(".event_title").css("font-size",((wid-1920)/100+25)+"px");
    $(".event_date").css("font-size",((wid-1920)/50+10)+"px");
    $(".event").css("height",((wid-1920)/70+80)+"%");
    $(".event").css("width",((wid-1920)/150+90)+"%");
