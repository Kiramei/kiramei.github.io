function closed() {
    ...
    $(".closer img").css("width",((wi-1920)/370+40)+"%");
    anime({
        targets: ".closer",
        opacity: 1,
        delay: 900,
...
function moviesh() {
    window.location.replace("jsp/movie.jsp");
    window.close()
}
function fad() {
    anime({
...
function showMusicPanel() {
    if (p == 0) {
      ...
      $("title").text("Kiramei ~The Eternal Light~");
